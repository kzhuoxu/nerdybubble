...
const Navbar = () => {
  ...
  return <>
      ...
      {/* Top Search Bar - Now scrolls with content instead of being fixed */}
      <div className={cn("w-full z-40 transition-all duration-200 px-4 py-3", isScrolled ? "bg-background/90 backdrop-blur-md shadow-sm" : "bg-transparent")}>
      ...
      <nav className="fixed bottom-0 left-0 w-full bg-background border-t border-border z-50 px-2 py-1">
        <div className="flex justify-around items-center">
          ...
          <NavButton label="Reader" icon={<BookOpen size={24} />} isActive={location.pathname.includes('/reader')} onClick={handleReaderNavigation} />
